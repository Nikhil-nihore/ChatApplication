...
public class client extends JFrame implements ActionListener { // sever class will extend jframe class which is imported from javaswing package
   ...
   static JTextArea a1; // created text area
    ...
    client() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("chhat/icons/elon.png"));
        ...
        JLabel lname = new JLabel("Elon Musk");
        ...
        setLocation(800, 50); // it will set the coordinates of the frame
